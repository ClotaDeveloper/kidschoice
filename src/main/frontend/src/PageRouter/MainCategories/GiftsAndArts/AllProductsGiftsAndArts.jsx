...
function AllProductsGiftsAndArts() {
  ...
  useEffect(() => {
    fetch("/allGiftsAndArts")
      ...
      .catch((err) => {
        console.error("Error fetching Gifts and Arts:", err);
        setLoading(false);
      });
  }, []);
  ...
  const handleToggle = () => {
    if (visibleCount >= items.length) {
      ...
      setVisibleCount((prev) => Math.min(prev + LOAD_COUNT, items.length)); // Expand
    }
  };
...
export default AllProductsGiftsAndArts;
