...
import TestPages from "../AdminPages/TestPages";
import SingleProductCar from "../MainCategories/Cars/SingleProductCar";
      ...
      <div className="flex flex-col min-h-screen bg-[#fffaf0] text-gray-800 font-sans">
        <main className="flex-grow pt-20 pb-10 px-4 md:px-10 bg-gradient-to-br from-yellow-50 to-pink-50">
          <Routes>
            ...
            <Route path="/testpage" element={<TestPages />} />
            ...
            {/* <Route path="/product/:id" element={<ProductDetails />} /> */}
            <Route path="/product/:productID" element={<SingleProductCar />} />
